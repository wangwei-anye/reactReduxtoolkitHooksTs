export const libjsesmini = () => {
  var _scriptDir =
    typeof document !== 'undefined' && document.currentScript
      ? document.currentScript.src
      : undefined;

  return function (libjsesmini) {
    libjsesmini = libjsesmini || {};

    var Module = typeof libjsesmini !== 'undefined' ? libjsesmini : {};
    ...
    var wasmBinaryFile;
    wasmBinaryFile = 'libjsesmini.wasm';
